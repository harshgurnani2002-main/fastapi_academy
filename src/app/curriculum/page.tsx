  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-200 pb-24">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden border-b border-slate-800">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-orange-500/10 via-slate-950 to-slate-950"></div>
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap items-center gap-8">
              <div className="flex flex-col">
                <span className="text-4xl font-black text-white">{totalChapters}</span>
                <span className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Chapters</span>
              </div>
              <div className="w-px h-12 bg-slate-800"></div>
              <div className="flex flex-col">
                <span className="text-4xl font-black text-white">{totalLessons}</span>
