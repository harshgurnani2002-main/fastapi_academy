...
lessons = [
    {
        ...
        "prerequisites": [],
        "objectives": ['Explain the ASGI interface specification', 'Understand scope/receive/send lifecycle', 'Compare ASGI vs WSGI concurrency models', 'Trace a request through the ASGI stack']
    },
    {
        "id": "01-02",
        ...
        "prerequisites": ["01-01"],
        "objectives": ['Understand FastAPI class hierarchy', 'Identify Starlette features used by FastAPI', 'Use Starlette routing directly when needed', 'Understand the request/response lifecycle']
    },
    {
        "id": "01-03",
        ...
        "prerequisites": ["01-02"],
        "objectives": ['Understand Pydantic v2 model compilation', 'Write efficient validators and serializers', 'Use model_config for advanced settings', 'Profile Pydantic validation performance']
    },
    {
        "id": "01-04",
        ...
        "prerequisites": ["01-03"],
        "objectives": ['Design layered dependency graphs', 'Implement scoped dependencies', 'Use dependencies for auth, db, and rate limiting', 'Write testable DI-based code']
    },
    {
        "id": "01-05",
        ...
        "prerequisites": ["01-04"],
        "objectives": ['Use the lifespan async context manager', 'Initialize connection pools on startup', 'Gracefully shut down background workers', 'Avoid resource leaks in production']
    },
    {
        "id": "01-06",
        ...
        "technologies": ["fastapi", "starlette"],
        "prerequisites": ["01-05"],
        "objectives": ['Understand middleware execution order', 'Write pure ASGI middleware', 'Add correlation ID middleware', 'Implement request timing middleware']
    },
    {
        "id": "01-07",
        ...
        "prerequisites": ["01-06"],
        "objectives": ['Design feature-based router structure', 'Use router prefixes and dependencies', 'Implement versioned API routers', 'Manage router-level error handlers']
    },
    {
        "id": "01-08",
        ...
        "technologies": ["fastapi", "python"],
        "prerequisites": ["01-07"],
        "objectives": ['Design the service layer interface', 'Inject repositories into services', 'Write pure business logic functions', 'Test service layers independently from HTTP']
    },
    {
        "id": "01-09",
        ...
        "prerequisites": ["01-08"],
        "objectives": ['Design repository interfaces with protocols', 'Implement async SQLAlchemy repositories', 'Write mock repositories for testing', 'Use repositories in service layers']
    },
    {
        "id": "01-10",
        ...
        "technologies": ["fastapi", "python"],
        "prerequisites": ["01-09"],
        "objectives": ['Understand clean architecture layers', 'Define domain entities vs. Pydantic schemas', 'Map between domain and infrastructure models', 'Keep business logic framework-independent']
    },
    {
        "id": "01-11",
        ...
        "technologies": ["fastapi", "python"],
        "prerequisites": ["01-10"],
        "objectives": ['Define port interfaces for external dependencies', 'Write adapters for PostgreSQL, Redis, and email', 'Swap adapters in tests without mocking', 'Structure the application for future flexibility']
    },
    {
        "id": "01-12",
        ...
        "technologies": ["pydantic", "python"],
        "prerequisites": ["01-11"],
        "objectives": ['Use BaseSettings for typed configuration', 'Manage .env files and environment overrides', 'Handle secrets securely in production', 'Validate configuration at startup']
    }
]

out = "import { Lesson } from '../types';\nimport { technologies } from '../technologies';\n\nexport const ch01Lessons: Record<string, Lesson> = {\n"

for l in lessons:
    techs = ", ".join(f"technologies.{t}" for t in l["technologies"])
    objs = ",\n      ".join(f"'{o}'" for o in l["objectives"])
    prereqs = ",\n      ".join(f"'{p}'" for p in l["prerequisites"])
    ...
    interviewQuestions: [
      {{
        id: 'iq-1',
        question: 'How does {l["title"]} improve application architecture?',
...
with open("/home/harsh/fastapi-academy/src/lib/content/lessons/ch01-lessons.ts", "w") as f:
    f.write(out)
